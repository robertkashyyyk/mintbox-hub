...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    icon: TrendingUp,
    items: [
      { title: "Scorecard", url: "/intelligence/scorecard", icon: LayoutDashboard, description: "RAG + trend across profit, 80/20, valuation and data quality — with Orin's narrative." },
      { title: "Profit Intelligence", url: "/intelligence/profit", icon: DollarSign, description: "Weekly revenue, costs, channel fees and POR." },
