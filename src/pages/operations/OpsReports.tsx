      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-foreground/60">Scheduled email reports and on-demand interactive reports</p>
          </div>
        </div>
      </div>
      ...
      <Tabs defaultValue="active" className="space-y-6">
        ...
        <TabsContent value="active" className="space-y-6">
          <p className="text-sm text-muted-foreground">
            Interactive reports you can pull on demand, with filters and export.
          </p>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card className="hover:border-pd-accent/60 transition-colors cursor-pointer" onClick={() => navigate("/operations/reports/despatch-performance")}>
              <CardHeader>
                <CardTitle className="flex items-center gap-2"><Truck className="h-5 w-5 text-pd-accent" /> Despatch Performance</CardTitle>
                <CardDescription>% of orders despatched within 24h / 48h / 72h. Filter by week, month, quarter or channel; export to CSV.</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <TableBody>
                    {logs.map((log) => (
                      <TableRow key={log.id}>
                        ...
                        <TableCell>
                          {log.status === 'success' ? (
                            <span className="flex items-center gap-1 text-success"><CheckCircle className="h-4 w-4" />Success</span>
                          ) : (
