    ...
    <div className="min-h-screen bg-background">
      <header className="border-b bg-card">
        <div className="container mx-auto px-4 py-4">
          ...
          <h1 className="text-2xl font-bold">Stock Updates</h1>
          <p className="text-sm text-muted-foreground">Manage stock synchronization and updates</p>
        </div>
      </header>
...
export default StockUpdatesSection;
