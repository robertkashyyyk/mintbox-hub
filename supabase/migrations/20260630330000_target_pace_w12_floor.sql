-- W12 floor for pace: YTD/quarter start no earlier than 2026-03-16 (finance horizon).
-- order_lines is missing Jan + most of Feb, so unfloored YTD compared full-Jan targets
-- vs ramp-only actuals => a false ~-42%. Floored YTD reflects reality (~-20%).
