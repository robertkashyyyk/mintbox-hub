-- ============================================================================
-- 20260630170000_amazon_sku_map_perf.sql
-- Perf fix for amazon_rebuild_sku_map(): the sku_normalize step nested-loop
-- seq-scanned products_cache (225k) per ASIN -> statement timeout. Materialise
-- upper(sku) once and hash-join; also raise the function's statement_timeout.
-- (Body identical to the original apart from the MATERIALIZED pc CTE + SET.)
-- ============================================================================
...
BEGIN
    ...
    -- 2. SKU-NORMALISE (hash-join against a materialised, normalised catalogue) -
...
ALTER FUNCTION public.amazon_sku_map_coverage() SET statement_timeout = '60s';
