-- 1. Roll back redundant columns added earlier today
ALTER TABLE public.products_cache
  DROP COLUMN IF EXISTS low_stock_alert,
  DROP COLUMN IF EXISTS low_stock_alert_synced_at;

ALTER TABLE public.brands
  DROP COLUMN IF EXISTS default_supplier_id;

-- 2. Rewrite buy-recommendations to use existing infrastructure
